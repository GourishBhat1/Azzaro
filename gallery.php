...
// Fetch data for category-based filtering
$galleryImages = [];
...
<head>
  ...
  <title>Gallery - Azzaro Resorts & Spas</title>
...
<body class="portfolio-page">
  ...
  <section id="portfolio" class="portfolio section">
    <div class="container">
      ...
      <!-- Portfolio Filters (Removed "All" button) -->
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    filters.forEach(filter => {
      filter.addEventListener('click', function () {
        ...
        let filterClass = this.getAttribute('data-filter').substring(1);
